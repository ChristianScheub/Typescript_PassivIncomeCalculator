export default {
  translation: {
    ...
    dashboard: {
      ...
      assetCalendar: 'Asset Calendar',
      symbol: 'Symbol',
      currentPrice: 'Current Price',
      change: 'Change',
      changePercent: 'Change %',
      goToSettingsToConfigureApiKey: 'Go to Settings to configure API key',
    },
    forecast: {
    ...
    settings: {
      ...
      clearPartialData: 'Clear Financial Data',
      clearPartialDataDescription: 'Delete all financial data (assets, expenses, liabilities, etc.) but keep settings like API key and exchange rates',
      clearAllData: 'Clear All Data',
      clearAllDataDescription: 'Delete everything including API keys and settings',
      clearingData: 'Clearing data...',
      dataCleared: 'Data cleared!',
      confirmClearPartialData: 'Are you sure you want to delete all your financial data? This cannot be undone.',
      confirmClearAllData: 'Are you sure you want to delete ALL data including your API keys? This cannot be undone.',
      stockApiConfig: 'Stock API Configuration',
      enableStockApi: 'Enable Stock API',
      enableStockApiDescription: 'Enable or disable the stock API integration',
      finnhubApiKey: 'Finnhub API Key',
      getFinnhubKey: 'Get your free API key from',
      toEnableStockData: 'to enable stock data features.',
      enterFinnhubApiKey: 'Enter your Finnhub API key',
      saving: 'Saving...',
      saved: 'Saved!',
      saveApiKey: 'Save API Key',
      apiKeyConfigured: '✓ API key configured',
      stockMarketCurrency: 'Stock Market Currency',
      stockMarketCurrencyDescription: 'Select the currency for displaying stock prices. USD shows original prices, EUR converts USD prices to Euro using live exchange rates.',
      eurAutoConverted: 'EUR (Auto-converted)',
      usdOriginal: 'USD (Original)',
      currentCurrency: 'Current: {{currency, currencyName}}',
    ...
    assets: {
      ...
      totalAssetsCount: '{{count}} total assets',
      shares: 'shares',
      ...
      form: {
        ...
        calculatedValueHelper: 'Automatically calculated from quantity × current price',
      },
      types: {
        all: 'All Asset Types',
        stock: 'Stock',
