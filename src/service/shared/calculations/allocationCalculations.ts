...
// Type for the income calculator function (can be injected from different services)
type IncomeCalculatorFunction = (income: Income) => number;
type AssetIncomeCalculatorFunction = (asset: Asset) => number;

export const calculateIncomeAllocation = (
  income: Income[], 
  assets: Asset[],
  calculateMonthlyIncome: IncomeCalculatorFunction,
  calculateAssetMonthlyIncome: AssetIncomeCalculatorFunction
): IncomeAllocation[] => {
