...
import { featureFlag_SetupImport } from "@/config/featureFlags";
...
const WelcomeStep: React.FC<WelcomeStepProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Skip Option */}
      <Card variant="filled" className="bg-gray-50">
      ...
      {featureFlag_SetupImport && (
        <>
          {/* Import at begin is not completed tested at this moment */}
                  ...
                  <Card className="bg-blue-50 border-blue-200">
                    <CardContent className="p-4">
                      <h5 className="font-medium text-blue-900 mb-2">
                        {t("setupWizard.welcome.import.guidelines.title")}
                      </h5>
                      <div className="text-sm text-blue-800 space-y-1">
                        <p>
                          <strong>
                            {t("setupWizard.welcome.import.guidelines.csvFormat")}
                          </strong>{" "}
                          {t(
                            "setupWizard.welcome.import.guidelines.csvDescription"
                          )}
                        </p>
                        <p>
                          <strong>
                            {t(
                              "setupWizard.welcome.import.guidelines.jsonFormat"
                            )}
                          </strong>{" "}
                          {t(
                            "setupWizard.welcome.import.guidelines.jsonDescription"
                          )}
                        </p>
                        <p>
                          <strong>
                            {t("setupWizard.welcome.import.guidelines.fileSize")}
                          </strong>{" "}
                          {t(
                            "setupWizard.welcome.import.guidelines.fileSizeDescription"
                          )}
                        </p>
                      </div>
                    </CardContent>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-green-700">
                    ...
                    <p className="mt-3">
                      {t("setupWizard.welcome.nextSteps.note")}
                    </p>
                  </div>
                </div>
              </div>
