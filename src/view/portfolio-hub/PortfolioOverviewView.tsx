...
interface PortfolioAnalytics {
  ...
  incomeSourcesBreakdown: Array<{ name: string; value: number; percentage: number }>;
  expenseCategoriesBreakdown: Array<{ name: string; value: number; percentage: number }>;
  liabilityTypesBreakdown: Array<{ name: string; value: number; percentage: number }>;
}
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <ViewHeader
          ...
          subtitle={t('portfolio.hub.subtitle', 'Manage your complete financial portfolio')}
          isMobile={!isDesktop}
        />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center md:text-right">
                ...
                <p className="text-blue-100 text-xs mt-1">
                  {formatService.formatCurrency(monthlyIncome)} {t('common.income')} - {formatService.formatCurrency(monthlyExpenses + monthlyLiabilityPayments)} {t('common.expenses')}
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card 
            ...
            onClick={() => onCategoryChange('assets', 'addTransaction')}
          >
            <CardContent className="p-4 text-center">
              <Plus className="w-8 h-8 mx-auto mb-2 text-blue-500" />
              <p className="text-sm font-medium">{t('portfolio.quickActions.addTransaction', 'Add Transaction')}</p>
            </CardContent>
          </Card>

          <Card 
            className="cursor-pointer hover:shadow-lg transition-shadow"
            onClick={() => onCategoryChange('income', 'addIncome')}
          >
            <CardContent className="p-4 text-center">
              <CreditCard className="w-8 h-8 mx-auto mb-2 text-green-500" />
              <p className="text-sm font-medium">{t('portfolio.quickActions.addIncome', 'Add Income')}</p>
            </CardContent>
          </Card>

          <Card 
            className="cursor-pointer hover:shadow-lg transition-shadow"
            onClick={() => onCategoryChange('expenses', 'addExpense')}
          >
            <CardContent className="p-4 text-center">
              <ReceiptText className="w-8 h-8 mx-auto mb-2 text-orange-500" />
              <p className="text-sm font-medium">{t('portfolio.quickActions.addExpense', 'Add Expense')}</p>
            </CardContent>
          </Card>

          <Card 
            className="cursor-pointer hover:shadow-lg transition-shadow"
            onClick={() => onCategoryChange('liabilities', 'addDebt')}
          >
            <CardContent className="p-4 text-center">
              <Landmark className="w-8 h-8 mx-auto mb-2 text-red-500" />
              <p className="text-sm font-medium">{t('portfolio.quickActions.addLiability', 'Add Debt')}</p>
            </CardContent>
          </Card>
        </div>
                {/* Portfolio Overview Section - Recent Activities & Recommendations */}
        <PortfolioHubRecommendations 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          {/* Assets Management */}
          <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => onCategoryChange('assets')}>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex space-x-2">
                    <Button 
                      onClick={(e) => { e.stopPropagation(); onCategoryChange('assets', 'portfolio'); }}
                      variant="secondary"
                      size="sm"
                    >
                    ...
                    <Button 
                      onClick={(e) => { e.stopPropagation(); onCategoryChange('assets', 'calendar'); }}
                      variant="outline"
                      size="sm"
                    >
          ...
          {/* Income Management */}
          <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => onCategoryChange('income')}>
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center text-lg">
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex space-x-2">
                    <Button 
                      onClick={(e) => { e.stopPropagation(); onCategoryChange('income', 'sources'); }}
                      variant="success"
                      size="sm"
                    >
          ...
          {/* Expenses Management */}
          <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => onCategoryChange('expenses')}>
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center text-lg">
                <ReceiptText className="w-5 h-5 mr-2 text-orange-500" />
                {t('portfolio.categories.expenses', 'Expenses Management')}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">{expenseCategoriesCount}</span>
                </div>
                <div className="flex items-center justify-between pt-2">
                  <div className="flex space-x-2">
                    <Button 
                      onClick={(e) => { e.stopPropagation(); onCategoryChange('expenses', 'categories'); }}
                      variant="warning"
                      size="sm"
                    >
          ...
          <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => onCategoryChange('liabilities')}>
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center text-lg">
                <Landmark className="w-5 h-5 mr-2 text-red-500" />
                {t('portfolio.categories.liabilities', 'Liabilities Management')}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex space-x-2">
                    <Button 
                      onClick={(e) => { e.stopPropagation(); onCategoryChange('liabilities', 'debts'); }}
                      variant="destructive"
                      size="sm"
                    >
                      {t('portfolio.manage', 'Manage')}
          ...
          {/* Transactions Center */}
          <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => onCategoryChange('transactions')}>
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center text-lg">
            ...
            <CardContent>
              <div className="space-y-3">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {t('portfolio.transactionsDesc', 'Unified transaction management across all categories')}
                </p>
                <div className="flex items-center justify-between pt-2">
                  <div className="flex space-x-2">
          ...
          {/* Portfolio Analytics */}
          <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => onCategoryChange('assets', 'portfolio')}>
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center text-lg">
