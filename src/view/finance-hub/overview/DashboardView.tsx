...
const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <PullToRefresh 
      ...
      pullToRefreshText={t('dashboard.pullToRefresh') || 'Zum Aktualisieren ziehen'}
      releaseToRefreshText={t('dashboard.releaseToRefresh') || 'Loslassen zum Aktualisieren'}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {miniAnalytics.map((analytic) => (
            <MiniAnalyticsCard
              ...
              icon={isDesktop ? <analytic.icon className={`h-4 w-4 ${analytic.colorClass}`} /> : undefined}
