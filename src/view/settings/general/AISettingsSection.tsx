  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        <Toggle checked={isAIEnabled} onChange={onAIToggle} id="ai-toggle" />
      </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
            ...
            {modelConfig && modelStatus === "loaded" && (
              <div className="text-xs text-gray-600 dark:text-gray-400">
                <p>
                  <strong>{t("ai.settings.loaded_model")}:</strong>{" "}
                  {modelConfig.modelName}
                </p>
                <p>
                  <strong>{t("ai.settings.mode")}:</strong> {modelMode}
                </p>
                <p>
                  <strong>{t("ai.settings.size")}:</strong>{" "}
                  {modelConfig.metadata?.modelSize}
                </p>
              </div>
            )}
